...
├── AGENTS.md              ← You are here — project navigation & how to work here
├── subscription-app/
...
- No code exists yet — these are planning and spec files.
- `.claude/settings.local.json` grants Go-related Bash permissions for the Go implementation.
- `.opencode/` installs OpenCode plugins (`@kilocode/plugin`, `@opencode-ai/plugin`).
