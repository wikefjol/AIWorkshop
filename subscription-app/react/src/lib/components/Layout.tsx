...
export default function Layout() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <aside
        className={[
          'fixed top-0 left-0 h-full w-[220px] flex flex-col z-30',
      ...
      >
        <div className="p-6 border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Subscription Audit Dashboard</div>
        </div>
      ...
      <div className="md:ml-[220px] min-h-screen bg-[var(--color-background)]">
        {/* Mobile hamburger */}
        <button
          className="md:hidden fixed top-4 left-4 z-10 p-2 rounded-md bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm cursor-pointer"
